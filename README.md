...
- **User Time:** 190.81s (This feels high)
- **Wall Clock:** 17.85s
- **CPU Usage:** 1137%
- **Max RSS:** 7.45 GB
- **Major Page Faults** 0 (no more)
- **Minor Page Faults:** ~1.95 Million
...
3. **The Goal:** I want to reduce the "User Time" and understand why I'm hitting 1.95 million page faults even when i used mmap in what i think is a correct manner.

## 🧠 What I'm Trying to Learn
I’m still early in a low level journey but i'm looking for the "Old School" wisdom that the docs don't cover:
- How can I parallelize the Xorshift generation without causing race conditions on the state?
- Is there a way to "warm" memory to avoid that massive page fault spike?
